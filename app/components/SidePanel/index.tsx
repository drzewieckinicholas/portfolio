    ...
    <Portal>
      ...
      >
        <div
          ...
          aria-modal='true'
          className='fixed right-0 top-0 z-20 h-full w-full max-w-xs border-l border-violet-300 bg-neutral-900'
          id={panelId}
          role='dialog'
        >
          <div className='flex h-20 items-center justify-end p-4'>
            <button
